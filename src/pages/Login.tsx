  ...
  return (
    <main className="font-jakarta bg-none md:bg-[url('/src/assets/images/background-login.webp')] md:bg-no-repeat md:bg-cover md:bg-center md:h-screen md:w-screen">
      <section className="bg-white w-full px-5 md:w-3/5 md:ml-[35%] md:mr-0 mx-auto pt-20">
        ...
        <h2 className="text-span mt-4 md:mt-7 font-bold text-2xl">Login</h2>
      ...
      <section className="bg-white w-full px-5 md:w-3/5 md:ml-[35%] md:mr-0 mx-auto">
        <div>
          <form onSubmit={onSubmitHandler}>
            ...
            <div className="text-right text-sm mb-5 text-primary hover:text-darkprimary active:text-darkprimary2">
              <a href="#">Lupa Password?</a>
            </div>
            <button className="text-lightblack text-lg bg-primary hover:bg-darkprimary active:bg-darkprimary2 rounded-lg w-full h-11" type="submit" disabled={isLoading}>
