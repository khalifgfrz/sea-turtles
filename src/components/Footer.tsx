  ...
  return (
    <footer className="font-jakarta flex w-full flex-wrap bg-darkgray justify-between py-[1%] px-[5%] tbt:px-[10%] mt-12">
      <div className="py-4 w-full tbt:w-1/2 md:w-fit">
        <img className="mb-4" width="160" height="40" src={logo} alt="footer-logo" />
        <p className="mb-7 text-sm text-lightgray lg:text-lg">
      ...
      <div className="py-4 w-1/2 tbt:w-1/4 md:w-fit">
        <h2 className="mb-6 font-bold text-sm lg:text-lg">Product</h2>
        <Link to="#" className="flex mb-4 text-lightgray text-sm lg:text-lg hover:underline active:text-lightgray2">
          Our Product
        </Link>
        <Link to="#" className="flex mb-4 text-lightgray text-sm lg:text-lg hover:underline active:text-lightgray2">
          Pricing
      ...
      <div className="py-4 w-1/2 tbt:w-1/4 md:w-fit">
        <h2 className="mb-6 font-bold text-sm lg:text-lg">Engage</h2>
        <Link to="#" className="flex mb-4 text-lightgray text-sm lg:text-lg hover:underline active:text-lightgray2">
          Partner
        </Link>
        <Link to="#" className="flex mb-4 text-lightgray text-sm lg:text-lg hover:underline active:text-lightgray2">
      ...
      <div className="py-4 tbt:w-1/4 md:w-fit h-1/2">
        <h2 className="mb-6 font-bold text-sm lg:text-lg">Social Media</h2>
        <div className="flex">
